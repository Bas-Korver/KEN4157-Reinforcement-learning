...
public class Gradient
{
    ...
    /**
     * Produces a high contrast gradient when in-between values don't really matter
     */
    public final static Color[] GRADIENT_HC = createMultiGradient(new Color[]{Color.red, Color.yellow, Color.blue, Color.white}, 4);
